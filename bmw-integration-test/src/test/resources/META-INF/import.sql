...
insert into pil_pilot values ('pilotId', 'Vorname', 'Nachname', 'secret', 'username');
insert into pil_pilot values ('com.prodyna.bmw.server.pilot.service.PilotLicenseServiceTest', 'Vorname', 'Nachname', 'secret', 'PilotLicenseServiceTest');
